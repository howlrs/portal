...
宇宙空間を飛び交う人工衛星やデブリの状況を、開発者が扱いやすいかたちで提供するプラットフォームが **[Orbit Bola!!](https://orbit-bola.com/)** です。寺島和宏 (howlrs) が開発・運営するこのサービスは、衛星オペレーターや宇宙関連の研究者が日々直面する「軌道データをどう取得し、どう解釈するか」という課題に正面から向き合っています。
