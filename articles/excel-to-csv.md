...
howlrs & rejoin LLC. のソフトウェアエンジニア・寺島和宏が開発したデスクトップツールです。Excelファイルをドラッグ＆ドロップするだけでCSVに変換できる、シンプルで使いやすいアプリです。

### 1. このツールについて
[github Release](https://github.com/howlrs/excel-to-csv/releases)
