...
ソフトウェアエンジニア 寺島和宏 が開発し、howlrs & rejoin LLC. が公開しているこのツールは、Google の Gemini AI を活用しています。
...
howlrs & rejoin LLC. では、AI を「自動化のための部品」として積極的に活用しています。AI Task Factorizer も「繰り返す認知作業をなくす」という明確な目的のもとに Gemini AI を組み込んでいます。
