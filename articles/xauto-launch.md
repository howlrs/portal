---
title: '【提供終了】自動投稿マネージャー: Twitter/X LONG POST AUTO WITH SCHEDULER のご紹介'
date: '2025-01-19'
description: '【提供終了】Twitter/X の API 仕様変更に伴い本サービスは停止しました。当ページは過去の機能紹介として残しているアーカイブです。'
---

> **【提供終了のお知らせ】**
> このサービスは Twitter/X の API 仕様変更に伴い、現在は提供を停止しています。本ページは公開当時の機能紹介をアーカイブとして残しているもので、新規のお申し込みや動作する公開エンドポイントはありません。文中のリンクや「無料トライアル」は当時のもので、現在は機能しません。

## もうSNS投稿に時間と手間を浪費しない！ ツイートを「未来予約」して、あなたの影響力を最大化する魔法

ソフトウェアエンジニアの寺島和宏 (howlrs)が開発した「LONG POST AUTO WITH SCHEDULER」は、Twitter/X の予約投稿を強力にサポートするツールです。

「毎日、ネタ探しと投稿時間に追われて、本当にやりたいことができない…」「せっかく書いたツイート、なぜかいつもタイミングがズレて、全然見てもらえない…」「もっとフォロワーに響く、魅力的なコンテンツを届けたいけど、どうすればいいのか分からない…」もし、あなたが Twitter/X（旧 Twitter）での情報発信に、こんな「もどかしさ」を感じていた方に向けて、このツールを提供していました。
...
本サービスは Twitter/X の API 仕様変更により提供を停止しました。本ページは公開当時の機能紹介を記録として残しているアーカイブです。新規の利用申込や動作する公開エンドポイントはありません。

過去にご利用いただいた方々、関心を寄せてくださった方々に感謝申し上げます。